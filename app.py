...
import time
import sqlite3
from puzzles import QDB as quests_list
...
LOCALIZED_UI = {
    ...
    "vi": {
        ...
        "victory_sub": "Cùng điểm lại thành tích của bạn nào!",
            "combined_subs": "Tổng Số lượt thực hiện", "timeline": "Chi Tiết quá trình giải đố", "attempts": "Lượt",
    ...
    "de": {
        ...
        "combined_subs": "Versuche insgesamt", "timeline": "Details des Rätselverlaufs", "attempts": "Versuche",
